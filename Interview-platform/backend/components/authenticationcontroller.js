...
const googlecallbackpage = async (req, res) => {
    ...
    if (!code || !state || !storestate || !codes || state !== storestate) {
        ...
        return res.redirect("interview-platform-3vs4xk1bd-madha66s-projects.vercel.app/login")
    }
    let tokens;
    try {
    ...
    res.redirect("interview-platform-3vs4xk1bd-madha66s-projects.vercel.app/landings")
}
